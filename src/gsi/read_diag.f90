...
! public :: iversion_radiag_4
  ...
  integer(i_kind),parameter :: ireal_radiag  = 31   ! number of real entries per spot in radiance diagnostic file
  integer(i_kind),parameter :: ireal_old_radiag  = 26   ! number of real entries per spot in versions older than iversion_radiag_2
  integer(i_kind),parameter :: ipchan_radiag = 9    ! number of entries per channel per spot in radiance diagnostic file
